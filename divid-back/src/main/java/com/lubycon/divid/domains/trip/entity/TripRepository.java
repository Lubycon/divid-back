package com.lubycon.divid.domains.trip.entity;
...
public interface TripRepository extends JpaRepository<Trip, UUID> {
    ...
    @Query("SELECT new com.lubycon.divid.domains.trip.dto.TripListResponse(T.tripId, T.tripName, T.startDate, T.endDate, T.end)" +
